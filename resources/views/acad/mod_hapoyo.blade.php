...
@endif
<form action="{{route('acad_modapoyo')}}" method="post" role="form">
    @csrf
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <select name="puesto" id="puesto" required class="form-control">
                                    @foreach($puestos as $cves)
                                        <option value="{{$cves->actividad}}" {{$cves->actividad==$puesto->actividad?' selected':''}}>{{$cves->descripcion_actividad}}</option>
                                    @endforeach
                                </select>
                            </div>
                        <div class="form-group">
                            <label for="especificar">Especifique la actividad</label>
                            <input type="text" name="especificar" id="especificar" required value="{{$puesto->especifica_actividad}}"
                                   class="form-control" maxlength="100" onchange="this.value=this.value.toUpperCase();">
                        </div>
                    </div>
                    <div class="card-body">
                        <?php
