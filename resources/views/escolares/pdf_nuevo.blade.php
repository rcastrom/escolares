        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    cordial bienvenida a ésta institución educativa.</p>
                    ...
                    <ol>
                        ...
                        conformado por la abreviatura de "alumno" mas tu número de control @ite.edu.mx; es decir, tu cuenta
                        de correo será al{{$control}}@ite.edu.mx  y   contraseña tecnologico, misma que deberás
