                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="true">
                    <li class="nav-item">
                        <a href="#" class="nav-link">
                            <i class="fas fa-user-friends"></i><p>Períodos<i class="right fas fa-angle-left"></i></p>
                        </a>
                        <ul class="nav nav-treeview collapse">
                            <li class="nav-item">
                                <a href="{{url('/personal/semestre')}}" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Período en curso</p></a>
                            </li>
                            <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{url('/personal/contrasena')}}" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Cambio de contraseña</p></a>
                            </li>
