...
<div class="header">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                Período {{$nombre_periodo[0]->identificacion_larga}}
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-12">
                Materia {{$nmateria[0]->nombre_completo_materia}} {{$materia}} Grupo: {{$grupo}}
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-12">
                Docente {{$docente[0]->nombre_empleado}} {{$docente[0]->apellidos_empleado}}
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div style="float: right">
                    Folio: {{$datos[0]->folio_acta}}
                </div>
            </div>
        </div>
    </div>
...
<div class="row justify-content-center">
    <table align="right">
        ...
        <tr>
            <td>{{$docente[0]->nombre_empleado}} {{$docente[0]->apellidos_empleado}}</td>
        </tr>
    </table>
</div>
