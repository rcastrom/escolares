    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <h6 class="card-title">Materia: {{$nmateria->nombre_abreviado_materia}}</h6>
                <h6 class="card-title">Horas por programar: {{$nmateria->creditos_materia}}</h6>
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{route('verano_grupo_alta')}}" method="post" role="form">
                        @csrf
                        <div class="form-group row">
                            <label for="grupo" class="col-sm-3 col-md-8 col-form-label">Grupo</label>
                            <div class="col-sm-8 col-md-3">
                                <input type="text" required class="form-control" name="grupo" id="grupo" maxlength="3">
                            </div>
                        </div>
                        <div class="form-group row">
