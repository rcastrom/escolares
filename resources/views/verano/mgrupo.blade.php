    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <h6 class="card-title">Materia: {{$mater->nombre_abreviado_materia}} Grupo{{$grupo}}</h6>
                <h6 class="card-title">Horas por programar: {{$mater->creditos_materia}}</h6>
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{route('verano_grupo_modifica')}}" method="post" role="form">
                        @csrf
                        ...
                        <input type="hidden" name="creditos" value="{{$mater->creditos_materia}}">
                    </form>
                </div>
            </div>
        </div>
